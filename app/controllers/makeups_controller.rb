class MakeupsController < ApplicationController
    ...
    def show
        ...
        render json: {reviews: makeup.reviews, makeup_id: makeup.id, user_id: current_user.id}, status: :ok
    end
    ...
    private
    def makeup_params
        params.permit(:id, :name,:product_type,:category,:brand,:currency,:price,:description,:image)
    end
